...
def home(self, command):
    if command == 'add':
        ...
        self.log.err('Please enter a valid command')
...
def generator(self, command):
    if command == 'back':
        ...
        self.og.err('Please enter a valid command')


def main(self, interface, command):
    ...
    if interface == 'home':
        try:
            ...
            self.log.blank(home_help)
    elif interface == 'listener':
        try:
            listener(self, command[1])
        except IndexError:
            self.log.blank(listener_help)
    elif interface == 'scout':
        try:
            scout(self, command[1])
        except IndexError:
            self.log.blank(scout_help)
    elif interface == 'generator':
        try:
            generator(self, command[1])
        except IndexError:
            self.log.blank(generator_help)
