...
def unload_com(load_off):
    if load_off == 'all':
        if config.scout_values['Windows'][0] == 'True':
            ...
            if interface == "GUI":
                config.app.logger.info("[library/commands/generator_interface/unload_com] - Unloaded all loaded windows components")
            elif interface == "CUI":
            ...
            if interface == "GUI":
                config.app.logger.info("[library/commands/generator_interface/unload_com] - Unloaded all loaded linux components")
            elif interface == "CUI":
        ...
        if load_off == 'base' or key_from_val.main(config.loaded_components, load_off) == 'base':
            if interface == "GUI":
                config.app.logger.warning("[library/commands/generator_interface/unload_com] - Do not unload base components, loading another base component will automatically replace the already loaded base component as there can only be one base component")
            elif interface == "CUI":
        ...
        try:
            ...
            if interface == "GUI":
                config.app.logger.info("[library/commands/generator_interface/unload_com] - Unloaded : " + name)
            elif interface == "CUI":
            ...
            if interface == "GUI":
                config.app.logger.info("[library/commands/generator_interface/unload_com] - Unloaded : " + load_off)
            elif interface == "CUI":
...
def main(command):
    try:
        ...
        for i in load_off:
            if interface == "GUI":
                config.app.logger.info("[library/commands/generator_interface/unload_com] - Unloading : " + str(i))
            elif interface == "CUI":
