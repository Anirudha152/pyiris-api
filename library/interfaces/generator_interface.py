...
def main(prompt = None):
    if interface == "GUI":
        ...
        if command == 'generate':
            output = generate.main(prompt)
        elif command == 'load_com':
            output = load_com.main(prompt)
        elif command == 'load_enc':
            output = load_enc.main(prompt)
        elif command == 'more_com':
            output = more_com.main(prompt)
        elif command == 'more_enc':
            output = more_enc.main(prompt)
        elif command == 'set':
            output = set.main(prompt)
        elif command == 'show':
            output = show.main(prompt)
        elif command == 'unload_com':
            output = unload_com.main(prompt)
        elif command == 'unload_enc':
            output = unload_enc.main(prompt)
        return output
    elif interface == "CUI":
